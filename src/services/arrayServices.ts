...
//import { ISeriesSort } from '../webparts/switcher/components/IReUsableInterfaces';

/**
 * Copied from Drilldown7 IReUsableInterfaces 2020-10-21
 */
 ...
 * 
 * Gives this error:
 * error TS2349: Cannot invoke an expression whose type lacks a call signature. Type '((compareFn?:
 *          ((compareFn?: (a: string, b: string) => number) => string[]) | ((compareFn?: (a: number, b: numbe...' has no compatible call signatures
 */
